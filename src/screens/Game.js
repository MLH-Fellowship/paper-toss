    ...
    <View style={styles.container}>
      ...
      ref={(ref) => { this.engine = ref; }}
        ...
        entities={{
          ...
          // Floor
          16: {position: [WIDTH/10, HEIGHT/2.3], category: "floor", renderer: <Bin/>},
          17: {position: [WIDTH/1.2, HEIGHT/2.3], category: "floor", renderer: <Bin/>},
          18: {position: [WIDTH/1.1, HEIGHT/2.3], category: "floor", renderer: <Bin/>},
          19: {position: [WIDTH/2, HEIGHT/2.3], category: "floor", renderer: <Bin/>},
          20: {position: [WIDTH/2.4, HEIGHT/2.3], category: "floor", renderer: <Bin/>},
          21: {position: [WIDTH/3, HEIGHT/2.3], category: "floor", renderer: <Bin/>},
          22: {position: [WIDTH/4, HEIGHT/2.3], category: "floor", renderer: <Bin/>},
          23: {position: [WIDTH/5, HEIGHT/2.3], category: "floor", renderer: <Bin/>},
          24: {position: [WIDTH/7, HEIGHT/2.3], category: "floor", renderer: <Bin/>},
          25: {position: [WIDTH/-125, HEIGHT/2.3], category: "floor", renderer: <Bin/>},
          26: {position: [WIDTH/-120, HEIGHT/2.3], category: "floor", renderer: <Bin/>},
          27: {position: [WIDTH/1.5, HEIGHT/2.3], category: "floor", renderer: <Bin/>},
          28: {position: [WIDTH/1.7, HEIGHT/2.3], category: "floor", renderer: <Bin/>},
          29: {position: [WIDTH/1.3, HEIGHT/2.3], category: "floor", renderer: <Bin/>},
        }}>
